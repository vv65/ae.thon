...
async def demote(dmod):
    ...
    # Assume we don't have permission to demote
        ...
        return
    await dmod.edit("Demoted this retard -  𖢞Successfully! ")
...
async def _(event):
    ...
    try:
        ...
        await event.edit(f"{input_cmd}ned -  𖢞Successfully! ")
...
async def promote(promt):
    ...
    try:
        await promt.client(
            EditAdminRequest(promt.chat_id, user.id, new_rights, rank))
        await promt.edit("-  𖢞Promoted Successfully! ")
...
async def pin(msg):
    ...
    if not to_pin:
        await msg.edit("-  𖢞Reply to a message to pin it ")
        return
    ...
    await msg.edit("-  𖢞Pinned Successfully! ")
